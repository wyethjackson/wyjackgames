...
function addComponentsFromContext(componentsContext, componentsFinal, typesLookup, typesArray) {
    ...
    var components = componentsContext._r_;
    var len;
    ...
    for (var i = len - 1; i >= 0; i--) {
        ...
        var flags = componentDef._f_;

        var state = component.state;
        var input = component.input;
        var typeName = component.typeName;
        var customEvents = component.l_;
        var scope = component.e_;
        var bubblingDomEvents = component.k_;
