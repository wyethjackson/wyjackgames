$_mod.def("/marko$4.16.1/src/components/util-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.16.1/src/components/dom-data'/*"./dom-data"*/);
