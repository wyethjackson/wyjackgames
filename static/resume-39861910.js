...
$_mod.def("/marko$4.16.1/src/components/boot", function(require, exports, module, __filename, __dirname) { if (window.$initComponents) window.$initComponents();

});
$_mod.run("/marko$4.16.1/src/components/boot");