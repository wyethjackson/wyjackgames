$_mod.def("/complain$1.3.0/index", function(require, exports, module, __filename, __dirname) { 'use strict';var process=require("process"); 

var StackParser = require('/error-stack-parser$2.0.2/error-stack-parser'/*'error-stack-parser'*/);
