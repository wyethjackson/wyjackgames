$_mod.def("/marko$4.16.1/src/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";
var componentUtil = require('/marko$4.16.1/src/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var addDelegatedEventHandler = require('/marko$4.16.1/src/components/event-delegation'/*"./event-delegation"*/)
