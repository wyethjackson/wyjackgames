$_mod.def("/marko$4.16.1/src/runtime/helpers", function(require, exports, module, __filename, __dirname) { "use strict";
var complain = "MARKO_DEBUG" && require('/complain$1.3.0/index'/*"complain"*/);
var removeDashes = require('/marko$4.16.1/src/compiler/util/removeDashes'/*"../compiler/util/removeDashes"*/);
var ComponentsContext = require('/marko$4.16.1/src/components/ComponentsContext'/*"../components/ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var ComponentDef = require('/marko$4.16.1/src/components/ComponentDef'/*"../components/ComponentDef"*/);
